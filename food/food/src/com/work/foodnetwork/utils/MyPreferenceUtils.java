...
public class MyPreferenceUtils {
	...
	private static final String PREF_NAME = "food_network";

	public static final String SETTING_GET_BY_LOCALE = "SETTING_GET_BY_LOCALE";
	...
	public static boolean getByLocale(Context context) {
		return getBoolean(context, SETTING_GET_BY_LOCALE, true);
	}

	public static void setByLocale(Context context, boolean enable) {
		saveBoolean(context, SETTING_GET_BY_LOCALE, enable);
	}
